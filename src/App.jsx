  ...
  return (
    <div className="calculator">
      ...
      <div className="calculator-buttons">
        <button className="calculator-button function" onClick={clear}>AC</button>
        <button className="calculator-button function" onClick={() => setDisplay(String(-parseFloat(display)))}>+/-</button>
        <button className="calculator-button function" onClick={() => setDisplay(String(parseFloat(display) / 100))}>%</button>
        <button className="calculator-button operator" onClick={() => performOperation('/')}>÷</button>
        ...
        <button className="calculator-button zero" onClick={() => inputDigit(0)}>0</button>
        <button className="calculator-button" onClick={inputDecimal}>.</button>
        <button className="calculator-button operator" onClick={handleEquals}>=</button>
      </div>
    </div>
  );
}
